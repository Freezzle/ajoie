...
public final class LoggingUtils {
    ...
    public static void addLogstashTcpSocketAppender(LoggerContext context, String customFields, SalonProperties.Logging.Logstash logstashProperties) {
    ...
    public static void addContextListener(LoggerContext context, String customFields, SalonProperties.Logging properties) {
        ch.salon.utils.LoggingUtils.LogbackLoggerContextListener loggerContextListener = new ch.salon.utils.LoggingUtils.LogbackLoggerContextListener(properties, customFields);
    ...
    private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
        private final SalonProperties.Logging loggingProperties;
        private final String customFields;

        private LogbackLoggerContextListener(SalonProperties.Logging loggingProperties, String customFields) {
        ...
        public void onStart(LoggerContext context) {
            if (this.loggingProperties.isUseJsonFormat()) {
                ch.salon.utils.LoggingUtils.addJsonConsoleAppender(context, this.customFields);
            }

            if (this.loggingProperties.getLogstash().isEnabled()) {
                ch.salon.utils.LoggingUtils.addLogstashTcpSocketAppender(context, this.customFields, this.loggingProperties.getLogstash());
            }
