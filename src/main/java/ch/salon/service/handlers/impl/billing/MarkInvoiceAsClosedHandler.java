...
@Component
public class MarkInvoiceAsClosedHandler implements BusinessActionHandler<InvoicingPlan> {

    private final EventLogService eventLogService;

    public MarkInvoiceAsClosedHandler(EventLogService eventLogService) {
