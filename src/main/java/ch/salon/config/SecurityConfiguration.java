    ...
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        http.cors(withDefaults())
            ...
            .authorizeHttpRequests(authz ->
                                       ...
                                       authz.requestMatchers(mvc.pattern("/index.html"), mvc.pattern("/*.js"),
                                            ...
                                            .hasAnyAuthority(AuthoritiesConstants.ADMIN,
                                                             AuthoritiesConstants.ADMIN_BUSINESS)
            ...
            .formLogin(formLogin -> formLogin.loginPage("/")
                                             ...
                                             .successHandler((request, response, authentication) -> response.setStatus(
                                                 HttpStatus.OK.value()))
                                             .failureHandler((request, response, exception) -> response.setStatus(
