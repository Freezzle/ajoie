...
/**
 * REST controller for managing {@link ch.salon.domain.Invoice}.
 */
@RestController
...
public class InvoiceResource {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Invoice> updateInvoice(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Invoice invoice)
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Invoice> getInvoice(@PathVariable("id") UUID id) {
