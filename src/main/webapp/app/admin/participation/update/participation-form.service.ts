...
export class ParticipationFormService {
    createParticipationFormGroup(participation: ParticipationFormGroupInput = {id: null}): ParticipationFormGroup {
        ...
        return new FormGroup<ParticipationFormGroupContent>({
                                                                ...
                                                                registrationDate: new FormControl(
                                                                    participationRawValue.registrationDate,
                                                                    Validators.required),
                                                                ...
                                                                acceptedChart: new FormControl(
                                                                    participationRawValue.acceptedChart),
                                                                acceptedContract: new FormControl(
                                                                    participationRawValue.acceptedContract),
                                                                needArrangment: new FormControl(
                                                                    participationRawValue.needArrangment),
                                                                isBillingClosed: new FormControl(
                                                                    participationRawValue.isBillingClosed,
                                                                    Validators.required),
                                                                status: new FormControl(participationRawValue.status,
                                                                                        Validators.required),
                                                                extraInformation: new FormControl(
                                                                    participationRawValue.extraInformation),
                                                                exhibitor: new FormControl(
                                                                    participationRawValue.exhibitor,
                                                                    Validators.required),
    ...
    private convertParticipationToParticipationRawValue(
        ...
        return {
            ...participation,
            registrationDate: participation.registrationDate ? participation.registrationDate.format(
