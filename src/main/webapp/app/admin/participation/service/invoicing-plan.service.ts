...
export class InvoicingPlanService {
    ...
    sendInvoice(idInvoicingPlan: string): Observable<HttpResponse<{}>> {
        return this.http.patch(
            this.applicationConfigService.getEndpointFor(`${this.resourceUrl}/${idInvoicingPlan}/send-invoice`),
            {},
            {
                observe: 'response',
            },
    ...
    sendInvoiceReceipt(idInvoicingPlan: string): Observable<HttpResponse<{}>> {
        return this.http.patch(
            this.applicationConfigService.getEndpointFor(`${this.resourceUrl}/${idInvoicingPlan}/send-invoice-receipt`),
            {},
            {
                observe: 'response',
            },
