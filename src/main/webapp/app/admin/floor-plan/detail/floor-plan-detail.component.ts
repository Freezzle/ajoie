...
@Component({
    ...
    imports: [SharedModule, CommonModule, RouterModule, CdkDragHandle, CdkDrag, CdkDropList, FormsModule,
        ReactiveFormsModule, ButtonBoxComponent, LinkBoxComponent, ColorStatusPipe, StatusPipe, AlertComponent]
})
