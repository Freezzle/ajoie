...
import { sampleWithRequiredData } from '../stand.test-samples';
import { StandService } from '../service/stand.service';

import { StandComponent } from './stand.component';
import SpyInstance = jest.SpyInstance;

describe('Stand Management Component', () => {
  let comp: StandComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(StandComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.stands?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to standService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getStandIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStandIdentifier).toHaveBeenCalledWith(entity);
