...
export class ParticipationComponent implements OnInit {
  ...
  trackId = (_index: number, item: IParticipation): string => this.participationService.getParticipationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.participations = this.refineData(dataFromBody);
  }

  protected refineData(data: IParticipation[]): IParticipation[] {
