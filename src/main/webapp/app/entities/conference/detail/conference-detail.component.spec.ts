...
describe('Conference Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { conference: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load conference on init', async () => {
      ...
      // THEN
      expect(instance.conference()).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
