...
import { sampleWithRequiredData } from '../exponent.test-samples';
import { ExponentService } from '../service/exponent.service';

import { ExponentComponent } from './exponent.component';
import SpyInstance = jest.SpyInstance;

describe('Exponent Management Component', () => {
  let comp: ExponentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ExponentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.exponents?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to exponentService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getExponentIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getExponentIdentifier).toHaveBeenCalledWith(entity);
