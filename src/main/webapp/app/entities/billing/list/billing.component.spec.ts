...
import { sampleWithRequiredData } from '../billing.test-samples';
...
describe('Billing Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.billings?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to billingService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getBillingIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBillingIdentifier).toHaveBeenCalledWith(entity);
