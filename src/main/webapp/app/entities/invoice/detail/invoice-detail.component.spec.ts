...
describe('Invoice Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { invoice: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load invoice on init', async () => {
      ...
      // THEN
      expect(instance.invoice()).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
