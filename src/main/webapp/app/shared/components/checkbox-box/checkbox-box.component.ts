...
import {
  ControlValueAccessor, FormControl, FormsModule, NgControl, ReactiveFormsModule, Validators,
} from '@angular/forms';
import SharedModule from '../../shared.module';
import { ErrorBoxComponent } from '../../error-box/error-box.component';

@Component({
  imports: [CommonModule, ReactiveFormsModule, FormsModule, SharedModule, ErrorBoxComponent],
